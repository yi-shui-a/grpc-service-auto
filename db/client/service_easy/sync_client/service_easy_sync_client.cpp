...
StartRequest_atomic_service_mbsb_task_A_Request_st *receiveData_8761100();
...
int main(int argc, char **argv)
{
    ...
    atomic_service_mbsb_task_A_Request_st request_9511898;
    
    atomic_service_sf_task_E_Request_st request_4201444;
    
    
    //为开始的服务赋值
    
    request_9511898.number1 = start_8761100->number1;
    
    request_9511898.number2 = start_8761100->number2;
    ...
    atomic_service_mbsb_task_A_Reply_st reply_9511898 = atomic_service_mbsb->atomic_service_fun_task_A(request_9511898);
    


    // 赋值
    
    request_4201444.sum_result = reply_9511898.sum_result;
    
    // 运行服务
    
    atomic_service_sf_task_E_Reply_st reply_4201444 = atomic_service_sf->atomic_service_fun_task_E(request_4201444);
    


    // 赋值
    
    std::cout << "service_easy output: " << std::endl
    
            << reply_4201444.sum_result << std::endl
    
            << reply_4201444.return_type << std::endl;
...
StartRequest_atomic_service_mbsb_task_A_Request_st *receiveData_8761100()
{
    ...
    topic = dds_create_topic(
        participant, &StartRequest_atomic_service_mbsb_task_A_Request_st_desc, "startA", NULL, NULL);
    if (topic < 0)
