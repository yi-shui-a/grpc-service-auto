#ifndef _ATOMIC_ATTACK_RADAR_H_
#define _ATOMIC_ATTACK_RADAR_H_
...
/**
  ******************************************************************************
  * @file:    atomic_attack_radar.h
  * @author:  Spiderman
  * @email:   Spidermsan@atomic_attack_radar.com
  * @version: V1.0.2
  ...
  *         +hard_disk: 50GB
  *
* @atomic_service_name: "atomic_attack_radar"
* @details_description: information about atomic_attack_radar
* @task_function_name:
* @developer:
        +name: yishui
        +email: yishui@atomic_attack_radar.com
@maintainer:
        +name:IronMan
