#ifndef _ATOMIC_SHOW_SJRH_H_
#define _ATOMIC_SHOW_SJRH_H_
...
/**
 *
 * @name:     atomic_show_sjrh
 * @chinese_name: 数据融合
 * @description: information atomic_show_sjrh
 * @version: V1.0.0
 * @build_time: 2024-05-23 16:00:00
 * @license: MIT
 * @service_path: atomic_show_sjrh
 *
 ...
 * @developer:
 *      +name: Spiderman
 *      +email: Spidermsan@atomic_show_sjrh.com
 * @maintainer:
 *      +name: yishui
 *      +email:yishui@atomic_show_sjrh.com
 * @operating_system:
 *      +name:Linux
