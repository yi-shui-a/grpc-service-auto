#ifndef _ATOMIC_SHOW_YCL_H_
#define _ATOMIC_SHOW_YCL_H_
...
/**
 *
 * @name:     atomic_show_ycl
 * @chinese_name: 数据融合
 * @description: information atomic_show_ycl
 * @version: V1.0.0
 * @build_time: 2024-05-23 16:00:00
 * @license: MIT
 * @service_path: atomic_show_ycl
 *
 ...
 * @developer:
 *      +name: Spiderman
 *      +email: Spidermsan@atomic_show_ycl.com
 * @maintainer:
 *      +name: yishui
 *      +email:yishui@atomic_show_ycl.com
 * @operating_system:
 *      +name:Linux
...
int getYCLData(ycl_input *request, ycl_output *reply);

/*------------------------  Interface Declaration End  --------------------------*/

#endif // _ATOMIC_SHOW_CGSJ_H_
