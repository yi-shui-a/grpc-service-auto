#ifndef _ATOMIC_SHOW_HJRD_H_
#define _ATOMIC_SHOW_HJRD_H_
...
/**
 *
 * @name:     atomic_show_hjrd
 * @chinese_name: 数据融合
 * @description: information atomic_show_hjrd
 * @version: V1.0.0
 * @build_time: 2024-05-23 16:00:00
 * @license: MIT
 * @service_path: atomic_show_hjrd
 *
 ...
 * @developer:
 *      +name: Spiderman
 *      +email: Spidermsan@atomic_show_hjrd.com
 * @maintainer:
 *      +name: yishui
 *      +email:yishui@atomic_show_hjrd.com
 * @operating_system:
 *      +name:Linux
