#ifndef _ATOMIC_TEST_FUSION_H_
#define _ATOMIC_TEST_FUSION_H_
...
/**
 *
 * @name:     atomic_test_fusion
 * @chinese_name: 数据融合
 * @description: information atomic_test_fusion
 * @version: V1.0.0
 * @build_time: 2024-05-23 16:00:00
 * @license: MIT
 * @service_path: atomic_test_fusion
 *
 ...
 * @developer:
 *      +name: Spiderman
 *      +email: Spidermsan@atomic_test_fusion.com
 * @maintainer:
 *      +name: yishui
 *      +email:yishui@atomic_test_fusion.com
 * @operating_system:
 *      +name:Linux
