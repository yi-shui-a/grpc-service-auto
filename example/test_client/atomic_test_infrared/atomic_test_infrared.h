#ifndef _ATOMIC_TEST_INFRARED_H_
#define _ATOMIC_TEST_INFRARED_H_
...
/**
 *
 * @name:     atomic_test_infrared
 * @chinese_name: 红外线搜索服务
 * @description: information atomic_test_infrared
 * @version: V1.0.0
 * @build_time: 2024-05-23 16:00:00
 * @license: MIT
 * @service_path: atomic_test_infrared
 *
 ...
 * @developer:
 *      +name: Spiderman
 *      +email: Spidermsan@atomic_test_infrared.com
 * @maintainer:
 *      +name: yishui
 *      +email:yishui@atomic_test_infrared.com
 * @operating_system:
 *      +name:Linux
...
#endif // _ATOMIC_TEST_INFRARED_H_
