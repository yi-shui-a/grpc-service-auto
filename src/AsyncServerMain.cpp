...
private: 
    ...
    class  atomic_service_mbsb_CallData {
        ...
        atomic_service_mbsb_service_->RequestUnitaryStream(&ctx_, &request_, &responder_, cq_, cq_, this);
            ...
            /******************************************************************/
            atomic_service_mbsb_interface_func(&atomic_service_mbsb_Request_t, &atomic_service_mbsb_Reply_t);
    ...
    private:
        ...
        ServerContext ctx_;
        atomic_service_mbsb_Package::atomic_service_mbsb_Request_st request_;
        atomic_service_mbsb_Package::atomic_service_mbsb_Reply_st reply_;
        ServerAsyncResponseWriter<atomic_service_mbsb_Package::atomic_service_mbsb_Reply_st> responder_;
