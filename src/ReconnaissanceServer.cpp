...
class atomic_service_sfzt_Service_ServerImpl ;

class atomic_service_skzt_Service_ServerImpl ;

class atomic_service_mbsb_Service_ServerImpl ;

class atomic_service_sj_Service_ServerImpl ;

class atomic_service_st_Service_ServerImpl ;
...
void RunServer(const std::string& ip, const std::string& port) {
    ...
    atomic_service_sfzt_Service_ServerImpl atomic_service_sfzt_instance;
    builder.RegisterService(&atomic_service_sfzt_instance);
    
    atomic_service_skzt_Service_ServerImpl atomic_service_skzt_instance;
    builder.RegisterService(&atomic_service_skzt_instance);
    
    atomic_service_mbsb_Service_ServerImpl atomic_service_mbsb_instance;
    builder.RegisterService(&atomic_service_mbsb_instance);
    
    atomic_service_sj_Service_ServerImpl atomic_service_sj_instance;
    builder.RegisterService(&atomic_service_sj_instance);
    
    atomic_service_st_Service_ServerImpl atomic_service_st_instance;
    builder.RegisterService(&atomic_service_st_instance);
